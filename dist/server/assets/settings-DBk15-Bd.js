...
import { Mail, Send, Loader2, Check, Globe2 } from "lucide-react";
import { u as useI18n, g as getUserSession, a as updateTelegram } from "./router-D5xPz8bV.js";
import { u as useAuth } from "./use-auth-CZ6S1gGb.js";
import "@tanstack/react-query";
import "@tanstack/react-router";
import "sonner";
import "zod";
import "./server-0JC-SxFr.js";
...
function SettingsPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-2xl p-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsx(Globe2, { className: "size-4" }),
        "Язык"
      ] }),
      /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs text-muted-foreground", children: "Частичная локализация — переключение временно заблокировано." }),
      /* @__PURE__ */ jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxs("select", { value: locale, disabled: true, className: "w-full rounded-xl border border-white/10 bg-background/40 py-2.5 px-3 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsx("option", { value: "ru", children: "Русский" }),
