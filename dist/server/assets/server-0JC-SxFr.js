...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DTkLE0Tv.js");
...
const manifest = {
  "017232d6b07b332cf47198212a3708ae83968c96004fdf3ead93bbfaac003041": {
    ...
    importer: () => import("./auth.functions-CTRHeJx0.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D5xPz8bV.js").then((n) => n.f),
    import("./start-CpoSoQ6o.js"),
