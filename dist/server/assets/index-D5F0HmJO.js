...
import { u as useI18n } from "./router-D5xPz8bV.js";
...
function Footer() {
  return /* @__PURE__ */ jsx("footer", { className: "border-t border-border/70 py-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 text-xs text-muted-foreground sm:flex-row", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
      /* @__PURE__ */ jsx(Link, { to: "/terms", className: "transition hover:text-foreground", children: "Условия" }),
      /* @__PURE__ */ jsx(Link, { to: "/privacy", className: "transition hover:text-foreground", children: "Политика" }),
      /* @__PURE__ */ jsx("a", { href: "https://t.me/help_clickbot", target: "_blank", rel: "noopener noreferrer", className: "transition hover:text-foreground", children: "Поддержка" })
    ] })
  ] }) });
}
export {
